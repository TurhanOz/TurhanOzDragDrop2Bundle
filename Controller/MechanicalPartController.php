...
use TurhanOz\DragDrop2Bundle\Form\MechanicalPartType;
...
class MechanicalPartController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TurhanOzDragDrop2Bundle:MechanicalPart')->findAll();
     ...
     * @Method("POST")
     * @Template("TurhanOzDragDrop2Bundle:MechanicalPart:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TurhanOzDragDrop2Bundle:MechanicalPart')->find($id);
     ...
     * @Method("PUT")
     * @Template("TurhanOzDragDrop2Bundle:MechanicalPart:edit.html.twig")
     */
