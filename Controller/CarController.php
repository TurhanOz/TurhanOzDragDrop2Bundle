...
use TurhanOz\DragDrop2Bundle\Entity\Car;
use TurhanOz\DragDrop2Bundle\Form\CarType;
...
class CarController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TurhanOzDragDrop2Bundle:Car')->findAll();
     ...
     * @Method("POST")
     * @Template("TurhanOzDragDrop2Bundle:Car:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TurhanOzDragDrop2Bundle:Car')->find($id);
     ...
     * @Method("PUT")
     * @Template("TurhanOzDragDrop2Bundle:Car:edit.html.twig")
     */
